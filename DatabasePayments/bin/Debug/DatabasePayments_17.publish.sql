...
CREATE PROCEDURE dbo.GetExchangePaymentsbyDateandBranchName 
	-- Add the parameters for the stored procedure here
	 ...
	 @AsOfDateEgiftperDay varchar(50),  --'12/23/2020'
	 @AsOfDatePaymentExchangeperDay varchar(50)    -- = '11/20/2020'
AS
BEGIN
...
(
select Country, Origin, ftxousd from [RR61].[dbo].[PaymentsExhange]   where AsofDate = @AsOfDatePaymentExchangeperDay
and Country =  @Branch
...
) as Risk on Payments.FUN = Risk.Country where Payments.[AsofDate] =  @AsOfDateEgiftperDay
